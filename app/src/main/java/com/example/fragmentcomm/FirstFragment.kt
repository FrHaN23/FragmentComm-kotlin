...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View,
        ...
        val sendUmurBtn = view.findViewById<Button>(R.id.send_button_fragment_3)
        val editTextUmur = view.findViewById<TextInputEditText>(R.id.textInputTextUmur)
        ...
        sendUmurBtn.setOnClickListener(){
            communicationViewModel!!.setUmur(editTextUmur.text.toString().toInt())
        }
    }
